package converterapp;
	...
	import converterlibrary.time_converter;
	...
	value1=sc.nextDouble();
	value2=distance_converter.Meter_To_Kilometer(value1);
	System.out.printf("%.2f meter is equal to %.2f Kilometer .\n", value1,value2);
	break;
	case 8:
	System.out.print("Enter the Distance:");
	value1=sc.nextDouble();
	value2=distance_converter.kilometer_To_Meter(value1);
	System.out.printf("%.2f kilometer is equal to %.2f meter .\n", value1,value2);
	break;
	case 9:
	System.out.print("Enter the Distance:");
	value1=sc.nextDouble();
	value2=distance_converter.Kilometer_To_Mile(value1);
	System.out.printf("%.2f kilometer is equal to %.2f mile .\n", value1,value2);
	break;
	case 10:
	System.out.print("Enter the Distance:");
	value1=sc.nextDouble();
	value2=distance_converter.Miles_To_kilometer(value1);
	System.out.printf("%.2f miles is equal to %.2f Kilometer .\n", value1,value2);
	break;
	case 11:
	System.out.print("Enter the time:");
	value1=sc.nextDouble();
	value2=time_converter.Hour_To_Minute(value1);
	System.out.printf("%.2f Hour  is equal to %.2f Minute .\n", value1,value2);
	break;
	case 12:
	System.out.print("Enter the time:");
	value1=sc.nextDouble();
	value2=time_converter.Minute_To_Hour(value1);
	...
	System.out.print("Enter the time:");
	value1=sc.nextDouble();
	value2=time_converter.Hour_To_Seconds(value1);
	System.out.printf("%.2f Hour  is equal to %.2f Seconds .\n", value1,value2);
	break;
	case 14:
	System.out.print("Enter the time:");
	value1=sc.nextDouble();
	value2=time_converter.Seconds_To_Hour(value1);
